...
%This function was generated by loadlibrary.m parser version  on Thu Mar  9 15:15:19 2017
...
% result_t __stdcall has_firmware ( const char * name , uint8_t * ret ); 
...
% result_t __stdcall command_update_firmware ( const char * name , const uint8_t * data , uint32_t data_size ); 
...
% result_t __stdcall write_key ( const char * name , uint8_t * key ); 
...
% device_t __stdcall open_device ( const char * name ); 
...
% result_t __stdcall probe_device ( const char * name ); 
...
% result_t __stdcall ximc_fix_usbser_sys ( const char * device_name ); 
...
structs.pid_settings_t.members=struct('KpU', 'uint32', 'KiU', 'uint32', 'KdU', 'uint32');
